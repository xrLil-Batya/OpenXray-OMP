...
#define CLSID_SV_GAME_FREEMP MK_CLSID('S', 'V', '_', 'F', 'R', ' ', 'M', 'P')
...
#define CLSID_CL_GAME_FREEMP MK_CLSID('C', 'L', '_', 'F', 'R', ' ', 'M', 'P')
// Game UI types
...
#define CLSID_GAME_UI_FREEMP MK_CLSID('U', 'I', '_', 'F', 'R', ' ', 'M', 'P')
